...
const ADS = [
  {
    ...
    headline: 'Raise Your Round Through One SPV',
    sub: 'Pool capital from multiple US investors into a single legal vehicle. Clean cap table, faster due diligence, one wiring instruction.',
  ...
  },
  {
    ...
    headline: 'Lead an SPV. Earn Carried Interest.',
    sub: 'Identify great startups, form an SPV, invite co-investors. Earn 20% carry on returns. Build your investment track record.',
  ...
  },
  {
    ...
    headline: 'From $5K to $5M — Invest via SPV',
    sub: 'Join institutional-quality SPVs from as little as $5,000. Access deals previously reserved for top-tier VCs and family offices.',
  ...
  },
  {
    ...
    tag: 'FOUNDER STORIES',
    headline: '$12M+ Raised Through LaunchingLaps SPVs',
    sub: 'Founders from 40+ countries have closed SPV rounds on our platform. One SPV. One wire. One cap table entry. Total clarity.',
  ...
  },
  {
    ...
    headline: 'The SPV Model is the Future of Early-Stage Investing',
    sub: 'Join 700+ entrepreneurs and investors already using the SPV model to invest smarter, raise faster, and build lasting relationships.',
