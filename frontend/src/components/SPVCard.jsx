...
export default function SPVCard({ spv }) {
  ...
  return (
    <div className="bg-white border border-zinc-200 rounded-xl overflow-hidden flex flex-col hover:border-zinc-300 hover:shadow-sm transition-all">
      ...
      <div className="px-5 pb-5">
        <Link
          to={`/spvs/${spv.id}`}
          className="block w-full text-center border border-zinc-200 bg-white hover:bg-zinc-50 text-zinc-700 text-sm font-medium px-4 py-2 rounded-lg transition-colors"
        >
          View →
        </Link>
      </div>
